...
export interface ToolMeta {
  ...
  /** つかいかた3ステップ(ツールページ冒頭に表示。UIを確認済みのツールのみ設定) */
...
export const TOOLS: ToolMeta[] = [
  {
    id: "genba-mitsumori",
    name: "げんばで見積",
    seoTitle: "げんばで見積(無料・見積書を保存して一覧・検索)",
    description:
      "工事項目マスタからタップで選ぶだけで、現場でサッと見積書。顧客ごとに保存・検索・複製できる見積台帳つき。",
    lead: "建設・リフォーム向けの見積アプリです。塗装・電気・内装・水回り・外構の工事項目マスタからタップで選ぶだけで明細ができあがり、値引き行もワンタップ。作った見積は自動で保存され、顧客名や件名で検索して複製もできます。印刷・PDF保存対応。単価はサンプルなので、現場に合わせて自由に変えてください。データはお使いの端末の中だけに保存されます。",
    emoji: "🧰",
    icon: "/icons/tools/genba-mitsumori.png",
    usageSteps: ["「新しい見積をつくる」を押す", "工事マスタからタップで項目を追加", "宛名を入れて印刷・PDFで提出"],
    customizeExamples: [
      "御社の単価表・よく使う工事項目を内蔵したカスタム版",
      "会社導入版（複数人で見積を共有するクラウド台帳）",
  ...
  },
  {
    ...
    usageSteps: ["URLを入れる", "色やロゴはお好みで調整", "PNG/SVGで保存してチラシへ"],
    customizeExamples: [
  ...
  },
  {
    ...
    usageSteps: ["写真をドラッグ(複数OK)", "軽くなった写真を確認", "ダウンロードしてHPやメールに"],
    customizeExamples: [
      "ホームページ更新時の自動圧縮の仕組み化",
      "商品写真の一括リサイズ+透かし入れ",
  ...
  },
  {
    ...
    usageSteps: ["明細に品名と金額を入れる", "右のプレビューで仕上がり確認", "印刷・PDF保存してそのまま提出"],
    customizeExamples: [
      "御社の単価表・よく使う工事項目を内蔵したカスタム版",
  ...
  },
  {
    ...
    usageSteps: ["請求書か領収書を選ぶ", "明細と宛名を入れる", "印刷・PDF保存してそのまま発行"],
    customizeExamples: [
      "顧客台帳とつないで宛名をワンタップ入力",
      "会計ソフトへの自動連携",
      "定期請求の自動発行・メール送付",
  ...
  },
  {
    ...
    usageSteps: ["メニュー名と金額を入れる", "税込/税抜はワンタップ切替", "A4印刷して店頭・卓上へ"],
    customizeExamples: [
  ...
  },
  {
    ...
    name: "多言語メニューメーカー",
    seoTitle: "多言語メニュー・料金表 作成(無料・英語/中国語/韓国語 併記・A4印刷)",
    description:
      "日本語のメニューを入れるだけで、英語・中国語・韓国語つきのメニュー表・料金表を作成。内蔵辞書で自動変換、A4印刷対応。",
    lead: "海外のお客様向けに、日本語と外国語を併記したメニュー表・料金表が作れます。ラーメン・カット・生ビールなど、よく使う言葉(約140語)は内蔵辞書がその場で英語・中国語・韓国語に変換。辞書にない言葉も手入力で自由に補えます。「おすすめ」「辛い」マークや税込の注意書きも自動で多言語表記に。A4印刷対応で、入力内容はお使いの端末の中にだけ保存されます。",
    emoji: "🌏",
    icon: "/icons/tools/multilingual-menu.png",
    usageSteps: [
      "メニュー名と金額を日本語で入れる",
      "内蔵辞書が英・中・韓を自動で併記",
      "A4印刷して店頭・卓上へ",
    ...
    customizeExamples: [
      "御社のメニューを全部内蔵した専用版(繁体字・タイ語など言語追加も)",
      "QRコードで読めるスマホ用の多言語メニューページ",
      "写真つきメニューブックのデザイン制作",
    ],
    released: true,
  },
  {
    ...
    usageSteps: ["固定費・変動費率・売値を入れる", "グラフで損益分岐点を確認", "値付けや目標の見直しに活用"],
    customizeExamples: [
